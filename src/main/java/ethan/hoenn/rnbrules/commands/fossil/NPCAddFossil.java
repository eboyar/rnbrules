...
public class NPCAddFossil {

	public static void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(
			Commands.literal("npcaddfossil")
				...
				.then(
					Commands.argument("npc", EntityArgument.entity()).executes(context -> {
						...
						entityData.putBoolean("Fossil", true);

						context.getSource().sendSuccess(new StringTextComponent("NPC set as Fossil NPC").withStyle(TextFormatting.GREEN), true);
