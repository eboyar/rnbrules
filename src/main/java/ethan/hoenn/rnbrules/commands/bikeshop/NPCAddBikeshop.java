...
public class NPCAddBikeshop {

	public static void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(
			Commands.literal("npcaddbikeshop")
				...
				.then(
					Commands.argument("npc", EntityArgument.entity()).executes(context -> {
						...
						entityData.putBoolean("Bikeshop", true);

						context.getSource().sendSuccess(new StringTextComponent("NPC set as Bikeshop NPC").withStyle(TextFormatting.GREEN), true);
