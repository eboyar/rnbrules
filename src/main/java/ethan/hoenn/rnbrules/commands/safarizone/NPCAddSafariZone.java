...
public class NPCAddSafariZone {

	public static void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(
			Commands.literal("npcaddsafarizone")
				...
				.then(
					Commands.argument("npc", EntityArgument.entity()).executes(context -> {
						...
						entityData.putBoolean("SafariZone", true);

						context.getSource().sendSuccess(new StringTextComponent("NPC set as Safari Zone NPC").withStyle(TextFormatting.GREEN), true);
