...
public class UnderpassGui {
    ...
    public static boolean giveFossilToPlayer(ServerPlayerEntity player, int fossilIndex) {
        ...
        ItemStack fossilItem = new ItemStack(ForgeRegistries.ITEMS.getValue(
            new ResourceLocation("pixelmon", fossilName)
        ));
        ...
        if (!player.inventory.add(fossilItem)) {
            ...
            player.sendMessage(
                new StringTextComponent("Your inventory is full! The fossil has been dropped on the ground.")
