...
public class FormatSelectionScreen extends ContainerScreen<FormatSelectionGui.FormatSelectionContainer> {

	private static final int GUI_WIDTH = 176;
	private static final int GUI_HEIGHT = 76;

	public FormatSelectionScreen(FormatSelectionGui.FormatSelectionContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
