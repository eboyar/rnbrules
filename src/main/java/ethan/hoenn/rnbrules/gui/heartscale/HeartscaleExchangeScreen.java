...
public class HeartscaleExchangeScreen extends ContainerScreen<HeartscaleExchangeGui.HeartscaleExchangeContainer> {

	public HeartscaleExchangeScreen(HeartscaleExchangeGui.HeartscaleExchangeContainer container, PlayerInventory inv, ITextComponent title) {
