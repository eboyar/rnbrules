...
public class PokeBallImpactListener {
	...
	private void handleGauntletStart(PokeBallImpactEvent event, ServerPlayerEntity player, String gauntletId, 
									 int trainerPosition, Map<String, List<String>> gauntlets, 
									 GauntletManager gm) {
	...
	private void handleActiveGauntletValidation(PokeBallImpactEvent event, ServerPlayerEntity player, String gauntletId, 
												int trainerPosition, Map<String, List<String>> gauntlets, 
												GauntletManager gm) {
	...
	private void sendCancelMessage(PokeBallImpactEvent event, ServerPlayerEntity player, String message) {
		PacketHandler.INSTANCE.sendTo(
			new CancelTeamSelectionPacket(message),
