...
public class PartyRestore extends Item {

	public PartyRestore(Properties properties) {
		super(properties);
	}
	...
	public ActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
		if (!world.isClientSide) {
			...
			if (stack.getDamageValue() != 6) {
				...
				player.sendMessage(new StringTextComponent("§7You must refill your §dParty Restore§7 at a healer machine."), player.getUUID());
