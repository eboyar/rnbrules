...
public class Music {
	...
	public boolean equals(Object o) {
		...
		Music music = (Music) o;
		return (
			Float.compare(music.volume, volume) == 0 &&
			Float.compare(music.pitch, pitch) == 0 &&
			Objects.equals(start, music.start) &&
			Objects.equals(loop, music.loop) &&
			Objects.equals(end, music.end) &&
			Objects.equals(fade, music.fade) &&
	...
	public String toString() {
		return "Music[" + String.join(",", Arrays.asList((start == null ? "" : start.toString()), (loop == null ? "" : loop.toString()), (end == null ? "" : end.toString()))) + "]";
	}
}
