...
public class PokeDollarReward extends Reward {
	...
	public void claim(ServerPlayerEntity serverPlayerEntity, boolean b) {
		...
		new DisplayRewardToastMessage(this.id, new TranslationTextComponent("ftbquests.reward.pixelmon.pokedollars.toast", this.count), Icon.getIcon("pixelmon:textures/gui/pokedollar.png")).sendTo(
			serverPlayerEntity
		);
	}
	...
	public IFormattableTextComponent getAltTitle() {
		return (new StringTextComponent(StringUtils.formatDouble(this.count, true) + " ")).append(this.getType().getDisplayName());
	}
