    ...
    public static void register() {
        try {
            ...
            BREED_POKEMON = TaskTypes.register(new ResourceLocation("pixelmon", "breed_pokemon"),
                    BreedTask::new, () -> Icon.getIcon("rnbrules:textures/gui/egg.png"));

            HATCH_EGG = TaskTypes.register(new ResourceLocation("pixelmon", "hatch_egg"),
                    HatchTask::new, () -> Icon.getIcon("rnbrules:textures/gui/egg2.png"));
            ...
            RELEASE_POKEMON = TaskTypes.register(new ResourceLocation("pixelmon", "release_pokemon"),
                    ReleaseTask::new, () -> Icon.getIcon("rnbrules:textures/gui/release2.png"));
