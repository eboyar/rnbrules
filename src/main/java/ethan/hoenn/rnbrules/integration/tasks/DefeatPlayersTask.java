...
public class DefeatPlayersTask extends Task {
	...
	public void onDefeat(TeamData teamData, ServerPlayerEntity defeated) {
		if (!teamData.isCompleted(this) && (username.isEmpty() || defeated.getGameProfile().getName().equals(username)) && (uuid.isEmpty() || defeated.getGameProfile().getId().equals(realUUID))) {
