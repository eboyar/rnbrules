...
public class BattleItemTask extends PokemonTask {
	...
	public enum ItemType {
		...
		BERRY(cheri_berry, chesto_berry, pecha_berry, rawst_berry, aspear_berry, leppa_berry, persim_berry, oran_berry, lum_berry, sitrus_berry, figy_berry, wiki_berry, mago_berry, iapapa_berry),
		STATUS_HEAL(
			heal_powder,
			burn_heal,
			full_heal,
		...
		BOOST(x_accuracy, x_attack, x_special_attack, x_defense, x_special_defense, x_speed, dire_hit, guard_spec, red_flute, blue_flute, green_flute, yellow_flute),
	...
	public void getConfig(ConfigGroup config) {
		...
		config.addEnum(
			...
			type,
			v -> type = v,
			NameMap.of(ItemType.REVIVE, ItemType.values())
