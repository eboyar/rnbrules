...
public class SubmitPokemonTask extends PokemonTask {
	...
	public void getConfig(ConfigGroup config) {
		...
		config.addEnum("party", this.party, v -> this.party = v, NameMap.of(Party.ONLY_PARTY, Party.values()).nameKey(v -> "pixeltweaks.party." + v.name().toLowerCase()).create());
	...
	public void addMouseOverText(TooltipList list, TeamData teamData) {
		...
		list.add(new TranslationTextComponent(key, new TranslationTextComponent("pixeltweaks.party." + this.party.name().toLowerCase())).withStyle(TextFormatting.GRAY));
