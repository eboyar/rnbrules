...
public class LevelTask extends PokemonTask {
	...
	public enum ExperienceCause {
		...
		EXP_CANDY(
			ExperienceGainType.SMALL_EXP_CANDY,
			ExperienceGainType.MEDIUM_EXP_CANDY,
			ExperienceGainType.LARGE_EXP_CANDY,
			ExperienceGainType.EXTRA_LARGE_EXP_CANDY,
			ExperienceGainType.EXTRA_SMALL_EXP_CANDY
		),
		ALL_CANDIES(
			ExperienceGainType.RARE_CANDY,
			ExperienceGainType.SMALL_EXP_CANDY,
			ExperienceGainType.MEDIUM_EXP_CANDY,
			ExperienceGainType.LARGE_EXP_CANDY,
			ExperienceGainType.EXTRA_LARGE_EXP_CANDY,
		...
		ALL_ITEMS(
			ExperienceGainType.RARE_CANDY,
			ExperienceGainType.RARE_SODA,
			ExperienceGainType.ULTRA_RARE_SODA,
			ExperienceGainType.SMALL_EXP_CANDY,
			ExperienceGainType.MEDIUM_EXP_CANDY,
			ExperienceGainType.LARGE_EXP_CANDY,
			ExperienceGainType.EXTRA_LARGE_EXP_CANDY,
	...
	public void getConfig(ConfigGroup config) {
		...
		config.addEnum("cause", cause, v -> cause = v, NameMap.of(ExperienceCause.ANY, ExperienceCause.values()).nameKey(exc -> "pixeltweaks.level_up_cause." + exc.name().toLowerCase()).create());
	}

	public void onLevel(TeamData team, Pokemon pokemon, ExperienceGainType cause) {
		if (!team.isCompleted(this) && team.file.isServerSide() && this.cause.matches(cause) && (this.cachedSpec == null || this.cachedSpec.matches(pokemon) != this.invert)) {
